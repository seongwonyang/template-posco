...
public class {{namePascalCase}} {{#checkExtends aggregateRoot.entities.relations namePascalCase}}{{/checkExtends}} {
    ...
    public void {{nameCamelCase}}({{#if (has fieldDescriptors)}}{{namePascalCase}}Command {{nameCamelCase}}Command{{/if}}){
        ...
        {{../namePascalCase}}Application.applicationContext.getBean({{../namePascalCase}}Service.class)
            .{{nameCamelCase}}(this{{#if (has fieldDescriptors)}}, {{nameCamelCase}}Command{{/if}});
    }
    {{/if}}
    {{/commands}}
    ...
    public {{returnType}} {{name}}(){
        // Call service layer method
        return {{../namePascalCase}}Application.applicationContext.getBean({{../namePascalCase}}Service.class)
            .{{name}}(this);
    }
    {{/isRootMethod}}
    {{/setOperations}}
